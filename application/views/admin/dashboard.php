...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3><?php echo $total_users[0]->total_users; ?></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3><?php echo $total_contacts[0]->total_contacts; ?></h3>
      ...
      <div class="row">
          <!-- Left col -->
       <?php /* <section class="col-lg-7 connectedSortable">
         ...
         <?php /* <section class="col-lg-5 connectedSortable">
